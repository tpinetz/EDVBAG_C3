...
\begin{center}
	\begin{tabularx}{\textwidth}{ |X|X|X| }
		...
		\hline
		Geschwindigkeit mit Matlab \newline funktionen berechnen & 25.11.2015 & 50\\ 
		\hline
		SIFT implementieren & 20.12.2015 & 180\\
		\hline
		Restliche Matlab funktionen
		
		 ausprogrammieren ( Filter, etc.) & 7.1.2016 & 20\\
		\hline		
...
Die erste Hürde war die sinnvolle und gleichmäßige Arbeitsaufteilung. Gruppen-intern wurde die Methodik 

Figure \ref{fig:implPipeline}
...
\begin{itemize}
	...
	\item ../Assets/2mpNoStativ1.jpg und ../Assets/2mpNoStativ1.jpg als Bilder, in denen die Distanz gemessen wird
\end{itemize}
